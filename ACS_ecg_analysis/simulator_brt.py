...
brt = np.genfromtxt("/Users/antonioaugello/Downloads/drive-download-20210914T100904Z-001/Raysi Keyvan/20210914_102001.brt", delimiter=',')[:15000]
brt = brt[~np.isnan(brt)]
brt = np.multiply(brt, 10000)

if not isinstance(brt, np.ndarray):
    brt = np.array(brt)

lowPassRemoved = Butterworth_Lowpass(brt, 4, 250, 8)
brt = movingAverageMeanBrt(lowPassRemoved)
...
class CustomMainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Real Time Breath")
        # Create FRAME_A
